...
help()
{
    ...
    printf("    +                     MENU                         +\n");
    printf("    ++++++++++++++++++++++++++++++++++++++++++++++++++++\n");
    printf("    Command: <-h>        show this help\n");
    printf("    Command: <start>     start preview and test start\n");
    printf("    Command: <stop>      stop preview and test exit\n");
    for (size_t i = 0; i < mvCmdMap.size(); i++)
    {
        printf("    Command: <%s>      enter <%s -h> for detail\n", mvCmdMap.keyAt(i).string(), mvCmdMap.keyAt(i).string());
    }
    printf("    ....................................................\n");
}
